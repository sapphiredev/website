...
to use arguments in your `Slash command` then please refer to the
[`discord.js guide`](https://discordjs.guide/interactions/slash-commands.html#options) about adding options to your
command.
