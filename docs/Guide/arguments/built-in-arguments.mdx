...
- `guildCategoryChannel`: Resolves to a [`CategoryChannel`][categorychannel] instance, given a category channel
  name, mention or ID.
...
- `guildStageVoiceChannel`: Resolves to a [`StageChannel`][stagechannel] instance,
  given a stage voice channel name, mention or ID.
- `guildTextChannel`: Resolves to a [`TextChannel`][textchannel] instance, given a text channel name, mention or ID.
- `guildThreadChannel`: Resolves to a [`ThreadChannel`][threadchannel] instance, given a thread
...
[mdn-date]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#several_ways_to_create_a_date_object
