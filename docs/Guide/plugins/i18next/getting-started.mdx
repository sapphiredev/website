...
`i18next.t`. Wondering how we you can handle formatting, interpolation, plurals and other [i18next] features? Yes, to
everything.
...
```bash npm2yarn2pnpm
npm install @sapphire/plugin-i18next @sapphire/framework discord.js@13.x
```
...
const client = new SapphireClient({
  ...
  i18n: {
    fetchLanguage: async (context: InternationalizationContext) => {
      // If this fetchLanguage is for an interaction we can return the language that the user has configured through Discord's UI
      // or the language that the server is configured to use.
      ...
      // If the command is ran outside of a guild then return the default language
      if (!context.guild) {
        return 'en-US';
      }
...
[resolve-key]: ../../../Documentation/api-plugins/modules/i18next_src.md#resolvekey
[fs-backend]: https://github.com/skyra-project/archid-components/tree/main/packages/i18next-backend
[fetchlanguage]: ../../../Documentation/api-plugins/modules/i18next_src.md#fetchlanguage
[i18n-options]: ../../../Documentation/api-plugins/interfaces/i18next_src.InternationalizationOptions
[sapphireclient]: ../../../Documentation/api-framework/classes/SapphireClient.md
...
[internationalizationcontext.guild]:
  ../../../Documentation/api-plugins/interfaces/i18next_src.InternationalizationContext#guild
[internationalizationcontext.channel]:
  ../../../Documentation/api-plugins/interfaces/i18next_src.InternationalizationContext#channel
[internationalizationcontext.user]:
  ../../../Documentation/api-plugins/interfaces/i18next_src.InternationalizationContext#user
[internationalizationcontext.interactionguildlocale]:
  ../../../Documentation/api-plugins/interfaces/i18next_src.InternationalizationContext#interactionguildlocale
[internationalizationcontext.interactionlocale]:
  ../../../Documentation/api-plugins/interfaces/i18next_src.InternationalizationContext#interactionlocale
[messagerun]: ../../../Documentation/api-framework/classes/Command.md#messagerun
[chatinputrun]: ../../../Documentation/api-framework/classes/Command.md#chatinputrun
[contextmenurun]: ../../../Documentation/api-framework/classes/Command.md#contextmenurun
[fetcht]: ../../../Documentation/api-plugins/modules/i18next_src.md#fetcht
[tfunction]: ../../../Documentation/api-plugins/interfaces/i18next_src.TFunction
