...
Similarly other enums can be used to represent time intervals too. Please see more enum members in the
[documentation](https://www.sapphirejs.dev/docs/Documentation/api-utilities/enums/time_utilities_src.Time).
