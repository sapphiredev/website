...
do so we need to acquire or use the [`registerApplicationCommands`][rac] to have access to the
[`ApplicationCommandRegistry`][acr] to perform operations on it. You can learn how to do this on the page [Acquiring an
Application Command Registry][aaacr].
