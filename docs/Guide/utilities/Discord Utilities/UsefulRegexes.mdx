...
This regex matches any animated or non-animated custom Discord emoji. Unlike EmojiRegex It can be a substring of a
larger string.

## Formatted Custom Emoji With Groups

Regex that can capture any animated or non-animated custom Discord emoji. Similar to FormattedCustomEmoji and unlike
EmojiRegex can also be a substring of a larger string.
