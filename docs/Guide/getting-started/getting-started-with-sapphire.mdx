...
If you want to use message commands in your bot ensure you have the message content privileged intent. and
LoadMessageCommandListeners to true in your client options. :::
