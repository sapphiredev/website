...
In order to start registering commands you need to create a subdirectory called `commands` (lowercase!) in your entry point directory. If you were following [Getting Started](./getting-started), it'll be `src/commands`.
