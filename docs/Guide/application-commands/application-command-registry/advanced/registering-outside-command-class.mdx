...
You are able to register you application commands inside of their command class, but also outside of the class! Whether it's a dynamic command or
premium command, Sapphire can help you manage your application commands with ease. If you're confused by the syntax,
read up on [what the registry means][registry].
