...
When using Sapphire it is important that you set a `main` property in your package.json. This is important because we
use this property to determine where we will need to look for your commands, listeners, events, and other pieces. If you
don't set this property, we will not be able to find your commands, listeners, events, and other pieces automatically
for you.

You should set this property to the `"main"` file of your project, this is where you call `client.login()`. For example,
if your `client.login()` is located at `src/index.js`, then you should set this property to `src/index.js`.
