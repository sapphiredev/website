...
call [`registerChatInputCommand`][rcic] to register your application command. An example looks like the following:
...
:::info A brief breakdown of `registerChatInputCommand`

This is the method which is responsible for telling the registry that this command should be registered. It takes two
parameters:
