...
Next, we can create a [`messageRun`][preconditionmessagerun] or [`chatInputRun`][preconditionchatinputrun] or
...
that's needed for your bot. Like if your bot has no `Slash` or `Context menu` command then `chatInputRun` and
`contextMenuRun` can be removed from the above example.
...
[preconditionmessagerun]: ../../Documentation/api-framework/classes/Precondition#messagerun
[preconditionchatinputrun]: ../../Documentation/api-framework/classes/Precondition#chatinputrun
[preconditioncontextmenurun]: ../../Documentation/api-framework/classes/Precondition#contextmenurun
