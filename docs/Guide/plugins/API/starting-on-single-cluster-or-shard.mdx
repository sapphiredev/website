...
[`automaticallyConnect`]:
  ../../../Documentation/api-plugins/@sapphire/plugin-api/interfaces/ServerOptions#automaticallyconnect
[`ClientOptions`]: ../../../Documentation/api-framework/interfaces/SapphireClientOptions
[`Server`]: ../../../Documentation/api-plugins/@sapphire/plugin-api/classes/Server
[`connect`]: ../../../Documentation/api-plugins/@sapphire/plugin-api/classes/Server#connect
[`shardReady`]: https://discord.js.org/docs/packages/discord.js/main/Client:Class#shardReady
