...
the `loadMessageCommandListeners` option set to `true`. For more information see the [`SapphireClientOptions#loadMessageCommandListeners`][load-message-ecommands-option] interface.
