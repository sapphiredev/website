...
[djs-client]: https://discord.js.org/docs/packages/discord.js/main/Client:Class
...
[`intents`]: https://discord.js.org/docs/packages/discord.js/main/ClientOptions:Interface#intents
